...
window.INGREDIENTS = {
    // 식물류 (접두어/접미어 힌트 포함)
    "wild_herb": { name: "산나물", icon: "🌿", type: "veg", adj: "신선한", power: 10 },
    "glow_mushroom": { name: "발광 버섯", icon: "🍄", type: "veg", adj: "번쩍이는", power: 15 },
    "radioactive_tomato": { name: "방사능 토마토", icon: "🍅", type: "veg", adj: "톡 쏘는", power: 12 },
    "dead_cactus": { name: "죽은 선인장", icon: "🌵", type: "veg", adj: "거친", power: 8 },
    "mutant_corn": { name: "변이 옥수수", icon: "🌽", type: "veg", adj: "팝핀", power: 10 },
    "acid_lemon": { name: "산성 레몬", icon: "🍋", type: "veg", adj: "시큼한", power: 12 },
    "ghost_flower": { name: "유령 꽃", icon: "🌷", type: "veg", adj: "오싹한", power: 15 },

    // 동물/괴수류
    "zombie_octopus": { name: "문어좀비 다리", icon: "🐙", type: "meat", adj: "꿈틀대는", power: 20 },
    ...
    "poison_stinger": { name: "독침", icon: "🦂", type: "meat", adj: "치명적인", power: 12 },
    ...
    "honey_goo": { name: "꿀 진득이", icon: "🍯", type: "fluid", adj: "진득한", power: 8 },
...
window.SPECIAL_RECIPES = [
    ...
    { id: "cook_5", name: "독침 찜", ingredients: ["poison_stinger", "rusty_salt"], icon: "🍲", desc: "독을 정화한 후 먹는 별미." },
    { id: "cook_6", name: "거대 알 오므라이스", ingredients: ["giant_egg", "sugar_cube"], icon: "🍛", desc: "달콤하고 든든한 한 끼." },
    { id: "cook_7", name: "철갑 게 그릴", ingredients: ["armored_crab", "engine_grease"], icon: "🦀", desc: "고열로 구워낸 단단한 속살." },
    { id: "cook_8", name: "유령 꽃 차", ingredients: ["ghost_flower", "water"], icon: "🍵", desc: "정신을 맑게(또는 아찔하게) 해줍니다." },
    { id: "cook_9", name: "번쩍이는 샐러드", ingredients: ["glow_mushroom", "acid_lemon"], icon: "🥗", desc: "비타민과 형광 물질이 가득." },
    { id: "cook_10", name: "달콤한 나물 무침", ingredients: ["wild_herb", "honey_goo"], icon: "🥗", desc: "피로 해소에 즉효입니다." },
    { id: "cook_11", name: "괴수 등갈비", ingredients: ["monster_meat", "rusty_salt"], icon: "🍖", desc: "짭짤하고 쫄깃한 고기 요리." },
