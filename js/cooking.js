...
window.INGREDIENTS = {
    ...
    "poison_stinger": { name: "독침 가재의 꼬리", icon: "🦂", type: "meat", adj: "치명적인", power: 12 },
    ...
    "rusty_salt": { name: "짠맛의 흰 가루", icon: "🧂", type: "fluid", adj: "짭짤한", power: 5 },
...
window.SPECIAL_RECIPES = [
    ...
    { id: "cook_5", name: "독침 찜", ingredients: ["poison_stinger", "rusty_salt"], icon: "🍲", recovery: 20, desc: "둘이 먹다 하나가 죽었어요!." },
    { id: "cook_6", name: "거대 알 오므라이스", ingredients: ["giant_egg", "sugar_cube"], icon: "🍛", recovery: 20, desc: "크다 커! 왜 이렇게나 크죠?." },
    ...
    { id: "cook_10", name: "달콤한 나물 무침", ingredients: ["wild_herb", "honey_goo"], icon: "🥗", recovery: 20, desc: "비명횡사를 막아보세요." },
