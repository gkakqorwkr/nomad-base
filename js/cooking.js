...
window.SPECIAL_RECIPES = [
    ...
    { id: "cook_5", name: "독침 찜", ingredients: ["poison_stinger", "rusty_salt"], icon: "🍲", recovery: 20, desc: "독을 정화한 후 먹는 별미." },
    { id: "cook_6", name: "거대 알 오므라이스", ingredients: ["giant_egg", "sugar_cube"], icon: "🍛", recovery: 20, desc: "달콤하고 든든한 한 끼." },
