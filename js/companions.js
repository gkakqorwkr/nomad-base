...
window.COMPANION_POOL = [
    // --- Super Rare (5%) ---
    { id: 'sr1', name: '전설의 안드로이드 A-9', type: 'humanoid', rarity: 'Super Rare', bonus: 2.5, role: 'Soldier', desc: '구시대의 정점이자 기계의 신입니다.', color: '#ffea00' },
    { id: 'sr2', name: '심해 변이 거대 문어', type: 'animal', rarity: 'Super Rare', bonus: 2.3, role: 'Researcher', desc: '지능이 매우 높고 여덟 팔로 모든 일을 돕습니다.', color: '#ffea00' },
    { id: 'sr3', name: '최후의 기사 아서', type: 'human', rarity: 'Super Rare', bonus: 2.2, role: 'Soldier', desc: '검 하나로 초토화된 도시를 지켜온 생존자입니다.', color: '#ffea00' },

    // --- Rare (25%) ---
    { id: 'r1', name: '특수부대 정찰견', type: 'animal', rarity: 'Rare', bonus: 1.6, role: 'Scout', desc: '훈련된 감각으로 위험을 미리 감지합니다.', color: '#00f2ff' },
    { id: 'r2', name: '방랑하는 사이보그', type: 'humanoid', rarity: 'Rare', bonus: 1.5, role: 'Engineer', desc: '자신의 부품을 게임기로 개조하고 싶어 합니다.', color: '#00f2ff' },
    { id: 'r3', name: '독수리 마스터', type: 'human', rarity: 'Rare', bonus: 1.5, role: 'Scout', desc: '하늘에서 내려다보는 시야를 공유합니다.', color: '#00f2ff' },
    { id: 'r4', name: '변이된 흰 사슴', type: 'animal', rarity: 'Rare', bonus: 1.7, role: 'Researcher', desc: '성스러운 기운이 주변 정화 작용을 돕습니다.', color: '#00f2ff' },
